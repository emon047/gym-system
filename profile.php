...
<head>
    ...
    <style>
        ...
        .custom-card {
            ...
            border-top: 4px solid #6f42c1 !important; /* Premium Purple Accent */
...
<body class="bg-light">
    ...
    <main class="container">
        ...
        <div class="text-center mb-4">
            ...
            <div class="mx-auto bg-purple rounded" style="width: 40px; height: 3px; background-color: #6f42c1;"></div>
        </div>
            ...
            <div class="col-md-8 col-lg-6">
                <div class="card p-4 shadow-sm border-0 custom-card">
                    ...
                    <div class="text-center mb-3">
                        <div class="d-inline-flex align-items-center justify-content-center bg-light text-purple rounded-circle shadow-sm" style="width: 60px; height: 60px; color: #6f42c1;">
                            <i class="fa-solid fa-user-gear fs-4"></i>
                        </div>
                        <h5 class="fw-bold text-dark mt-2 mb-0">My Account Profile</h5>
                    </div>
                    ...
                    <div class="px-2 mb-3">
                        ...
                        <div class="profile-row">
                            ...
                            <span class="profile-value text-muted font-monospace"><?php echo sanitize($user['email']); ?></span>
                        </div>
                        <div class="profile-row">
                        ...
                        <div class="profile-row">
                            <span class="profile-label"><i class="fa-solid fa-calendar-day me-2 opacity-50"></i>Joined System On</span>
                            <span class="profile-value font-monospace text-muted small"><?php echo sanitize($user['created_at']); ?></span>
                        </div>
                    </div>
